...
void DrawCross(DWORD color)
{
	...
	int center_y = static_cast<int>(screen_height / 2);

	ImGui::GetForegroundDrawList()->AddCircleFilled(ImVec2(center_x, center_y), Settings::aimbot::crosshair_size, ImColor(color));
}
